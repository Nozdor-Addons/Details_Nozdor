...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	--> captures
		...
		g:NewSwitch (frame10, _, "$parentWriteAllAuraslider", "writeAllAurasSlider", 60, 20, _, _, _detalhes.NozdorCustom.WriteAllAuras, nil, nil, nil, nil, options_switch_template)
		...
		frame10.writeAllAurasSlider.OnSwitch = function (self, _, value)
			_detalhes.NozdorCustom.WriteAllAuras = value
		end
...
function window:CreateFrame11()
	...
	--> general tools
		...
		g:NewSwitch (frame11, _, "$parentAnnouncersCustomSlider1", "AnnouncersCustomSlider1", 60, 20, _, _, _detalhes.NozdorCustom.MurazondDmgSkip, nil, nil, nil, nil, options_switch_template)
		...
		frame11.AnnouncersCustomSlider1.OnSwitch = function (_, _, value)
			_detalhes.NozdorCustom.MurazondDmgSkip = value
			-- _detalhes:SendOptionsModifiedEvent (DetailsOptionsWindow.instance)
		end
		...
		g:NewSwitch (frame11, _, "$parentAnnouncersCustomSlider2", "AnnouncersCustomSlider2", 60, 20, _, _, _detalhes.NozdorCustom.EnterInCombatWhenHeal, nil, nil, nil, nil, options_switch_template)
		...
		frame11.AnnouncersCustomSlider2.OnSwitch = function (_, _, value)
			_detalhes.NozdorCustom.EnterInCombatWhenHeal = value
			-- _detalhes:SendOptionsModifiedEvent (DetailsOptionsWindow.instance)
		end
